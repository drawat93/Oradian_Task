...
import utilities.OradianUtilities;
...
public class BaseClass
{
	...
	public OradianUtilities util;
	public ReadProperties read=new ReadProperties();
	public HomePageObject homeObject;
	public LoginPageObject loginObject;
	public TasksPageObject taskObject;
	...
	public void setupExtentReports()
	{
		...
		htmlReporter.config().setDocumentTitle("Instafin Test Report");
		htmlReporter.config().setReportName("Instafin Test Automation Report");
